defmodule FCInventory.Router.MarkOrderTest do
  ...
  test "dispatch invalid command" do
    assert {:error, {:validation_failed, errors}} = Router.dispatch(%MarkOrder{})
  ...
  describe "dispatch command by" do
    ...
    test "authorized staff", %{cmd: cmd} do
      ...
      assert_receive_event(OrderMarked, fn event ->
