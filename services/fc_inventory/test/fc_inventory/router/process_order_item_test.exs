defmodule FCInventory.Router.ProcessOrderItemTest do
  ...
  alias FCInventory.ProcessOrderItem
  alias FCInventory.{
    OrderCreated,
    OrderItemProcessed
  }
  ...
  test "dispatch invalid command" do
    assert {:error, {:validation_failed, errors}} = Router.dispatch(%ProcessOrderItem{})
  ...
  describe "dispatch command by" do
    ...
    test "authorized staff", %{cmd: cmd} do
      ...
      assert_receive_event(OrderItemProcessed, fn event ->
