defmodule FCInventory.Router.CreateLineItemTest do
  ...
  describe "given valid and authorized command for" do
    test "stockable with unsufficient quantity on hand", %{cmd: cmd} do
      account_id = uuid4()
      requester_id = user_id(account_id, "goods_specialist")
      client_id = app_id("standard", account_id)
      ...
      line_item_id = uuid4()
      cmd = %{cmd | line_item_id: line_item_id, client_id: client_id, account_id: account_id, requester_id: requester_id}
