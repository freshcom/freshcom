defmodule FCInventory.Router.FinishStockReservationTest do
  ...
  alias FCInventory.FinishStockReservation
  alias FCInventory.{
    OrderCreated,
  ...
  test "dispatch invalid command" do
    assert {:error, {:validation_failed, errors}} = Router.dispatch(%FinishStockReservation{})
  ...
  describe "dispatch command by" do
    ...
    test "authorized staff", %{cmd: cmd} do
      ...
      assert_receive_event(StockReservationFinished, fn event ->
