defmodule FCInventory.Router.AddLocationTest do
  ...
  test "given invalid command" do
    assert {:error, {:validation_failed, errors}} = Router.dispatch(%AddLocation{})
  ...
  test "given valid command with authorized role", %{cmd: cmd} do
    ...
    assert_receive_event(LocationAdded, fn event ->
